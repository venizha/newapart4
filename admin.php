...
<body>
    ...
    <form action="add_tenant.php" method="post">
        <input type="text" name="user_name" placeholder="Tenant Name" required><br>
        <input type="number" name="tid" placeholder="ID" required><br>
        ...
        <input type="number" name="rent_amt" placeholder="Rent Amount" required><br>
